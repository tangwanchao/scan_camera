...
object OpenCameraInterface {
    ...
    private const val NO_REQUESTED_CAMERA = -1

    /**
     * Opens the requested camera with [Camera.open], if one exists.
     *
     * @param cameraIdParam camera ID of the camera to use. A negative value
     ...
     */
    fun open(cameraIdParam: Int): OpenCamera? {
        var cameraId = cameraIdParam
